		...
		<div class="cwrapper980">
			...
			<div class="page-content blog-list-wrapper" >
                ...
                <?php					
						...
						if ( $data['gmap_360'] ) {
							$gmap_360 = $data['gmap_360'];
						}
						
						if ( $gmap_360 ) { ?><div><?php _e($data['gmap_360'],'qns'); ?><?php } ?></div>
							...
							<div class="borderino">
								...
								<div class="undertitle bordertop2px" style="width:100%; height:13px;"></div>
										...
										<ul class="contact_list">
                                            ...
                                            <div class="fb-like" style="margin-top:8px;" data-href="<?php if ( $social_facebook ) {_e($data['social_facebook'],'qns'); } ?> " data-send="true" data-layout="button_count" data-width="250" data-show-faces="false"></div>
